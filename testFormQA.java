  ...
  public void Test001_partialLink() {
	...
	@Test
	  public void Test003_LinkTest() throws InterruptedException {
		String imgPath="/home/qainfotech/Downloads/img_avatar2.png";
	  driver.navigate().back();
			driver.findElement(By.xpath("//div/input[@name='firstname']")).sendKeys("Aditya");
			driver.findElement(By.xpath("//div/input[@name='lastname']")).sendKeys("Singh");
			driver.findElement(By.xpath("//div/input[@name='sex'][@value='Male']")).click();
